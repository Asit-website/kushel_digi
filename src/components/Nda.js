      ...
      <div className="ser-main">
        <div className="nda-back">
          <div className="nda-sect">
            <h2>NDA (NON DISCLOUSER AGREEMENT)</h2>
          </div>
        </div>
        <div className="nda-section terms">
          <div className="nda-header">
            <h2>NDA Policy</h2>
            <div className="nda-para mt-1">
              <p>We are dedicated to protect your idea and data.</p>
              <p className="nda-another">
                Kushel Digi protects your website and application ideas and
                handles data securely and safely during the improvement and
                development segments using diverse networks and operational
                securities.
              </p>
              <p className="nda-another">
                Being a leading development agency, we recognise a
                non-disclosure Agreement (NDA) holds immense value when you want
                to develop your dream application or website. So to make certain
                your app idea is safe with us, we sign an NDA.
              </p>
              <p className="nda-another">
                NDA is a confidentiality settlement that is a written agreement
                between two parties (customers and companies). It prohibits the
                sharing of sensitive information, enterprise techniques or
                startegies, and website or application ideas.
              </p>
            </div>
          </div>
          <hr className="hr-quality hr-quality1" />
          <div className="nda-header nda-header1">
            <h2>Overview of Our NDA</h2>
            <div className="nda-para mt-1">
              <p className="er">
                Kushel digi is dedicated to secure and handle all the sensitive
                data and business information regarding administrative,
                technical and physical hurdles. All the laws and regulations are
                followed and industry level encryption is maintained. While
                using our software we make sure that all of the sensitive
                information, business strategies and ideas are automatically
                encrypted, securely back up is taken, and stored safely. We have
                a team that’s specifically committed and looks after all of the
                matters related to signing of the NDA and provide you assistance
