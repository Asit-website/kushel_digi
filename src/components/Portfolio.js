    ...
    <>
      <div className="ser-main">
        ...
        <div className="portfolio-nav">
          <p id="pw" onClick={taf1} className="all-port">ALL</p>
          <p id="px" onClick={taf2} >WEBSITE DESIGN</p>
          <p id="py" onClick={taf3}>E-COMMERCE SOLUTION</p>
          <p id="pz" onClick={taf4}>MOBILE APPLICATION</p>
        </div>
        ...
        {/* =================1st============= */}
        {
          ...
          <div className="portis mt-12">
            <div className="portis2 pong1">
              <h3>PRO TRUCKS</h3>
              <p className="kick-eez">
                Aftermarket suspension lift kits, leveling kits and accessories
                for 4X4 off-road truck and jeep enthusiasts
              </p>
              <div className="port-usa">
                <div className="port-usa1">
                  <img src={porta} alt="" />
