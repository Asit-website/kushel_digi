          ...
          <div className="white-label-cards mt-10">
            <div className="white-level-card">
              ...
              >
                ...
                <p>
                  As white label solutions require very little or no time of
                  your own, you can focus on other expertise and deliver the
                  best solutions. So, what are you waiting for? Get in touch
                  with us (CTA) to know about how to partner with us.
                </p>
              </div>
              <div
                className="white-level-box"
              ...
              >
                ...
                <p>
                  When you offer a wide range of services to the clients, you
                  would be able to enjoy a higher retention rate as they would
                  keep coming back to you again and again for different
                  services.
                </p>
              </div>
            </div>
        ...
        <div className="latest">
          ...
          <div className="business-card business1-card flex-wrap mt-20">
            <div className="business-box business-box1 relative text-center cursor-pointer white-soni">
              ...
              <p>
                During the first month of an ongoing digital marketing campaign
                we’ll craft the strategy first. This is important so everyone is
                on the same page when we start. We do this so you can visualize
                everything that will be happening, and to also have a “basecamp”
                location were everything is recorded.
              </p>
            </div>
            <div className="business-box business-box1 relative text-center cursor-pointer white-soni">
              <div className="business-card-img">
              ...
              <p>
                Depending on what we are doing and what we are tracking you and
                your client will also receive ongoing reporting of analytics
                where it applies. We think it’s important to see how thingsare
                progressing.
              </p>
            </div>
            <div className="business-box business-box1 relative text-center cursor-pointer white-soni">
              ...
              <p>
                If it is a service centered around traffic building we’ll
                provide the numbers each month. We need to see what’s working
                and what isn’t.
              </p>
            </div>
            <div className="business-box business-box1 relative text-center cursor-pointer white-soni">
              ...
              <p>
                Communication will be a very important part of our growing
                partnership. You will have a dedicated person for all
                correspondence toensure everyone is on the same page.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <SplideSlide>
                <div className="img_container">
                  ...
                  <h5 className="you_tube">
                    Watch on
                    <img src={youtube} className="youtube_icon" /> Youtube
                  </h5>
          ...
          <div className="why-work-cards mt-10">
            <div className="why-work-card">
              <div className="why-work-box why-work-box1">
                ...
                <p>
                  We are 100% transparent! No client is left in the dark. You
                  know what we’re doing at all times.
                </p>
              </div>
              <div className="why-work-box why-work-box2">
                <img src={seoOning} alt="t" />
                <p>
                  Our SEO services are proven. Just read through the numerous
                  case studies on our site.
                </p>
              </div>
              <div className="why-work-box why-work-box3">
                <img src={seoOning1} alt="t" />
                <p>
                  We are a quality vs. quantity agency who provides the
                  attention you need to make an impact.
                </p>
              </div>
              <div className="why-work-box why-work-box4">
                <img src={tanning2} alt="t" />
                <p>
                  We are results driven! We constantly adjust to make sure you
                  see the growth you’re looking for.
                </p>
              </div>
            </div>
          </div>
