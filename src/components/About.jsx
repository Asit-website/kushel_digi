        ...
        <>
            <div className="about-main">
                ...
                <div className="about-main3">
                    <div className="about-main31 flex">
                ...
                <div className="about-main4">
                    <div className="about-main41">
                        <h1 className='text-white text-center'>Be Fair With Today to build</h1>
                        ...
                        <div className="about4 flex justify-center">
                            <div className="about41 text-center mr-1">
                                ...
                                <h5>Vision</h5>
                                <p>Provide best in class product & service to our partner and thereby providing ultimate experience to users with the objective of adding value to their life. For the employees, establishing kushel digi as the best platform to serve customers with a culture of fun, team building, safety, freedom, innovation and value addition as core values, Along with unmatched value to all our stakeholders.</p>
                            </div>
                            <div className="about41 text-center ml-1">
                                <img src="/static/images/e10.png" alt="" />
                                <h5>Our Mission</h5>
                                <p>Disrupt global Website & App development and gaming industry by offering value driven customized products, Motivated and passionate employees aligned with shared vision of serving the customers. Our mission is to add constant values to our stakeholders.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="about-main5">
                    <div className="about-main51">
                        ...
                        <p>Over the past 10 Years our values have been the driving force that keeps us on right path</p>
