    ...
    <>
      <div className="ser-main">
        ...
        <div className="php_techStack">
              ...
              <div className="mt-3">
              <p className="php_para1">Our PHP developers have a firm grasp of all major PHP frameworks as well as a profound understanding</p>
              <p className="php_para1">of PHP coding peculiarities to nail the most elaborate project requirements.</p>
              </div>
                  ...
                  <div className="php_techStack_card">
                      <div className="php_techStack_box php_techStack_box1">
                           ...
                           <div className="tech_right">
                              <h4>Backend</h4>
                              <h4>Frameworks:  <span>Laravel, Yii2, Zend, Slim, Symfony</span> </h4>
                              <h4>Pure PHP </h4>
                              <h4>CMS: <span>Joomla, Drupal. Ecommerce: Magento, Opencart, Prestashop.</span> </h4>
                           </div>
                      </div>
        ...
        <div className="why_kushel_php">
             ...
             <div className="why_me_card">
                 <div className="why_me_box why_me_box1">
                      ...
                      <p>We focus on stable and fruitful cooperation, offering value for money PHP services. This is proved by 20+ clients that stay with us for more than 5 years.</p>
                 </div>
